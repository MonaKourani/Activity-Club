...
<div class="container mt-5">
    ...
    <form id="editEventForm">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="categories" name="categories" hint="write the categories separated by a comma and a space">
